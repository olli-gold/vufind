...
/**
 * Related Records: FRBR-Records from PrimoCentral Frbr-Group-ID
 *
 * @category VuFind2
 * @package  Related_Records
 * @author   Oliver Goldschmidt <o.goldschmidt@tuhh.de>
 ...
 * @link     http://vufind.org/wiki/vufind2:building_a_related_record_module Wiki
 */
class PrimoFrbr implements RelatedInterface
{
    /**
     * Similar records
     *
    ...
    {
        $this->results
            = $driver->getFrbrRecords($driver->getUniqueId(), $driver->getFrbrId());
    }
